...
<head>
    <title>Admin - Fuerteventura 2000</title>
    <meta name="author" content="Inversiones Borma S.L.">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta charset="utf-8">
    <!-- SEO -->
    <meta name="description" content="Acceso al administrador de Fuerteventura2000">
    <meta property="og:site_name" content="Fuerteventura2000">
    <meta property="og:title" content="Admin - Fuerteventura 2000">
    <meta property="og:url" content="{{url()->full()}}">
    <meta property="og:description" content="Acceso al administrador de Fuerteventura2000">
...
<div class="container-fluid absoluteCenterBoth">
    <div class="row">
        <div class="col-xl-4 offset-xl-4 col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-12 offset-0 bg-white adminAccessBox rounded shadow">
            <form action="{{url('adminLogin')}}" method="post" class="p-lg-5 p-4">
                <div>
                    {{csrf_field()}}
                    <h2 class="color-deep-blue text-center"><strong>¡Bienvenido/a!</strong></h2>
                    <input autocomplete="on" class="styledInput w-100 mt-4" type="text" name="email" placeholder="Email" required>
...
<script type="text/javascript" id="clearStorageScript">
    localStorage.clear();
    $('#clearStorageScript').remove();
</script>
